...
<html>
<head>
    <title>find.torrent :: <?php echo ucwords($rel); ?></title>
    ...
    <link href="../assets/styles/rels.css" rel="stylesheet" type="text/css"/>
</head>
<body>
<div id="container">
    <div class="navbar">
    ...
    <?php echo \Michelf\MarkdownExtra::defaultTransform($yield); ?>
</div>
